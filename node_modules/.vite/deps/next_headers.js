...
var import_browser_external_node_async_hooks = (/* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "node:async_hooks" has been externalized for browser compatibility. Cannot access "node:async_hooks.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
})))();
/**
...
var _registry = _g$2[_REGISTRY_KEY] ??= /* @__PURE__ */ new Set();
/**
...
function getOrCreateAls(key) {
	...
	const als = _g$2[sym] ??= typeof import_browser_external_node_async_hooks.AsyncLocalStorage === "function" ? new import_browser_external_node_async_hooks.AsyncLocalStorage() : new NoopAsyncLocalStorage();
	_registry.add(als);
	return als;
}
//#endregion
...
var APPLY_RESPONSE_COOKIE = Symbol("vinext.apply-response-cookie");
...
function createDraftModeCookie(value, expires) {
	const isDevelopment = typeof process !== "undefined" && true;
