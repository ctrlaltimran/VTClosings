...
import { n as getDeploymentId } from "./deployment-id-BDirTScQ.js";
...
*/
var __dangerouslyAllowSVG = process.env.__VINEXT_IMAGE_DANGEROUSLY_ALLOW_SVG === "true";
/**
...
*/
var __dangerouslyAllowLocalIP = process.env.__VINEXT_IMAGE_DANGEROUSLY_ALLOW_LOCAL_IP === "true";
var __globallyUnoptimized = process.env.__VINEXT_IMAGE_UNOPTIMIZED === "true";
/**
...
*/
var RESPONSIVE_WIDTHS = [...__imageDeviceSizes].sort((left, right) => left - right);
var ALL_IMAGE_WIDTHS = [...RESPONSIVE_WIDTHS, ...__imageSizes].sort((left, right) => left - right);
...
function preloadImageResource(input) {
	...
	if (typeof import_react_dom.preload !== "function") return;
	import_react_dom.preload(input.src, {
		as: "image",
...
var Image = (0, import_react.forwardRef)(function Image({ src: srcProp, alt, width, height, fill, preload, priority, quality, placeholder, blurDataURL, loader, sizes, className, style, onLoad, onLoadingComplete, onError, unoptimized: _unoptimized, overrideSrc, loading, ...rest }, ref) {
	...
	const [completedBlurSrc, setCompletedBlurSrc] = (0, import_react.useState)(void 0);
	...
	if (isRemoteUrl(src)) {
		...
		if (!validation.allowed) console.warn(`[next/image] ${validation.reason}`);
		const sanitizedBlur = imgBlurDataURL ? sanitizeBlurDataURL(imgBlurDataURL) : void 0;
...
function getImageProps(props) {
	...
	const skipOpt = isSvgUrl(resolvedSrc) && !__dangerouslyAllowSVG || !!loader || isRemoteUrl(resolvedSrc);
